...
/**
 * An {@link Invocation} getting the result of a no-argument method by evaluating an EL
 * expression.
 * 
...
public class SimpleMethodInvocation implements Invocation {
    ...
    public SimpleMethodInvocation(ELContext context, MethodExpression expr) {
